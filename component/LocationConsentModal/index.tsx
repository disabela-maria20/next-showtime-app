  ...
  return (
    <Modal.Root>
      <Modal.Body setOpen={closeModal} className="max-w-md">
        ...
        <Modal.Footer>
          <StreamButton variant='ghost' size='md' onClick={handleDeny} className="px-4 py-2 rounded-lg border">
            Não permitir
          </StreamButton>

          <StreamButton variant='primary' size='md' onClick={handleAccept} className="px-4 py-2 rounded-lg bg-blue-600 text-white">
            Permitir
          </StreamButton>
        </Modal.Footer>
      </Modal.Body>
